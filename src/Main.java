...
class Main {
    ...
    private static int subLogic1(int[][] paper, int i, int j) {
        ...
        max = Math.max(max, paper[i][j] + paper[i][j+1] + paper[i+1][j+1] + paper[i][j+2]);
        max = Math.max(max, paper[i][j] + paper[i+1][j] + paper[i+1][j+1] + paper[i+1][j+2]);
        max = Math.max(max, paper[i+1][j] + paper[i][j+1] + paper[i+1][j+1] + paper[i+1][j+2]);
        max = Math.max(max, paper[i+1][j] + paper[i+1][j+1] + paper[i+1][j+2] + paper[i][j+2]);
        max = Math.max(max, paper[i][j] + paper[i+1][j] + paper[i+1][j+1] + paper[i+1][j+2]);
        max = Math.max(max, paper[i+1][j] + paper[i+1][j+1] + paper[i][j+1] + paper[i][j+2]);
    ...
    private static int subLogic2(int[][] paper, int i, int j) {
        ...
        max = Math.max(max, paper[i][j] + paper[i+1][j] + paper[i+1][j+1] + paper[i+2][j]);
        max = Math.max(max, paper[i][j] + paper[i][j+1] + paper[i+1][j+1] + paper[i+2][j+1]);
        max = Math.max(max, paper[i][j+1] + paper[i+1][j+1] + paper[i+1][j] + paper[i+2][j]);
        max = Math.max(max, paper[i][j+1] + paper[i+1][j+1] + paper[i+2][j+1] + paper[i+2][j]);
        max = Math.max(max, paper[i][j+1] + paper[i+1][j+1] + paper[i+1][j] + paper[i+2][j+1]);
        max = Math.max(max, paper[i][j+1] + paper[i][j] + paper[i+1][j] + paper[i+2][j]);
